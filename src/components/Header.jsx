      ...
      <div style={styles.titleRow}>
        <div style={styles.logoGroup}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>GAMING SENTIMENT INTELLIGENCE PLATFORM</p>
          </div>
        </div>
        <div style={styles.statusGroup}>
          <StatusBadge label="RAWG API" status="ONLINE" />
          <StatusBadge label="SENTIMENT ENGINE" status="ACTIVE" />
        </div>
      </div>

      <div style={styles.divider}>
        <div style={styles.dividerLine}></div>
        <span style={styles.dividerText}>◆ EDITORIAL ANALYSIS SUITE ◆</span>
        <div style={styles.dividerLine}></div>
      </div>
    </header>
  );
