  ...
  return (
    <div style={styles.report}>
      ...
      <div style={styles.gameHeader}>
        ...
        <div style={styles.gameInfo}>
          <div style={styles.gameMetaTop}>
            <span style={styles.gameTag}>◈ SELECTED TITLE</span>
          ...
          <div style={styles.gameStats}>
            <Stat label="RAWG RATING" value={game.rating ? `${game.rating.toFixed(1)}/5` : 'N/A'} />
            <Stat label="RATINGS COUNT" value={game.ratings_count?.toLocaleString() || '0'} />
            <Stat label="REVIEWS ANALYZED" value={sentimentData.totalAnalyzed} />
            <Stat label="METACRITIC" value={game.metacritic || 'N/A'} highlight={game.metacritic} />
          </div>
        </div>
      </div>
      ...
      <div style={styles.sectionDivider}>
        <span style={styles.sectionTitle}>◆ SENTIMENT ANALYSIS RESULTS</span>
      </div>
      ...
      <div style={styles.mainPanel}>
        ...
        <div style={styles.metricsSection}>
          ...
          <div style={styles.distCard}>
            <div style={styles.cardLabel}>SENTIMENT DISTRIBUTION</div>
            <DistBar label="POSITIVE" value={sentimentData.distribution.positive} color="#00ff88" />
            <DistBar label="MIXED" value={sentimentData.distribution.mixed} color="#f5c542" />
            <DistBar label="NEGATIVE" value={sentimentData.distribution.negative} color="#ff4466" />
          </div>

          {/* Signal Analysis */}
          <div style={styles.signalCard}>
            <div style={styles.cardLabel}>SIGNAL ANALYSIS</div>
      ...
      {/* Divider */}
      <div style={styles.sectionDivider}>
        <span style={styles.sectionTitle}>◆ INDIVIDUAL REVIEW BREAKDOWN</span>
      </div>
      ...
      <div style={styles.footerNote}>
        ...
        <span style={styles.footerText}>
          Sentiment analysis based on keyword extraction from {sentimentData.totalAnalyzed} user reviews via RAWG API.
          Results are indicative and complement professional editorial judgment.
        </span>
      </div>
    </div>
  );
...
function LoadingPanel() {
  return (
    <div style={styles.loadingPanel}>
      ...
      <div style={styles.loadingText}>SCANNING REVIEWS...</div>
      <div style={styles.loadingSubtext}>Fetching & analyzing community sentiment</div>
    </div>
  );
}
...
function NoData({ game }) {
  return (
    <div style={styles.noData}>
      ...
      <div style={styles.noDataText}>No community reviews found for this title.</div>
      <div style={styles.noDataSub}>RAWG may not have user reviews indexed for this game yet.</div>
    </div>
  );
}
...
function ReviewItem({ review, analysis, index }) {
  ...
  const text = review.text || review.description || '';
  ...
  return (
    <div style={{ ...styles.reviewItem, animationDelay: `${index * 0.05}s` }}>
      <div style={styles.reviewHeader}>
        <div style={styles.reviewUser}>
          ...
          <span style={styles.reviewUsername}>
            {review.user?.username || `user_${index + 1}`}
          </span>
        </div>
      ...
      <div style={styles.reviewLabel}>
        <span style={{ ...styles.reviewSentiment, color }}>{analysis.label}</span>
      </div>
      {preview && (
        <div style={styles.reviewText}>{preview || '(no text)'}</div>
      )}
